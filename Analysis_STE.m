...
% %
% %
% % save( 'Final_Results_Distance.mat', 'corr_100', 'corr_5', 'corr_1', 'ratio_traj2min', 'discr_50', 'discr_10', 'discr_1', 'pseudo_discr_50', 'pseudo_discr_10', 'pseudo_discr_1' )
% %
% %
...
% %
% %
% % save( 'Final_Results_Distance.mat', 'corr_100', 'corr_5', 'corr_1', 'ratio_traj2min', 'discr_50', 'discr_10', 'discr_1', 'pseudo_discr_50', 'pseudo_discr_10', 'pseudo_discr_1', 'collected_samples', 'dist_X', 'dist_Z_1', 'dist_Z_2', 'images' )
% %
% %
% load( 'Final_Results_Distance.mat' )
% 
...
% hold on
% for fn = 2 : 4
%     errorbar( fn - 0.15 - 1, m_corr_1( fn, 1 ), s_corr_1( fn, 1 ), 'k' )
%     errorbar( fn + 0.15 - 1, m_corr_1( fn, 2 ), s_corr_1( fn, 2 ), 'k' )
% end; clear fn
% set( gca, 'ylim', [ 0, 1 ] )

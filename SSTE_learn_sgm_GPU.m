function [ W_f, b_f, LS ] = SSTE_learn_sgm_GPU( X, io_f, hl_f, lambda, kWidth, miniBatchSize, nPred, nMaxIter, varargin )
% Learning Sparse Spatio-temporally Efficient coding.
...
% e.g.) [ W_f, b_f, LS ] = SSTE_learn_sgm( X, io_f, hl_f, lambda, kWidth, miniBatchSize, nPred, nMaxIter, 'initial', W_f, b_f )
% params : learning parameters of Adam optimization.
% e.g.) [ W_f, b_f, LS ] = SSTE_learn_sgm( X, io_f, hl_f, lambda, kWidth, miniBatchSize, nPred, nMaxIter, 'params', alpha, beta1, beta2, epsilon )

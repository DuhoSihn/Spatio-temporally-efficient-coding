function [ Z, oZ ] = STE_f_sgm_GPU( Z_input, io_f, W_f, b_f )
% f : X -> Z
...
for h = 1 : nH + 1
    ...
    if h == 1
        ...
        for p = 1 : nP( h )
            ...
            for l = 1 : nL{ h, d }( p, 1 )
                ...
                if l < nL{ h, d }( p, 1 )
                    ...
                    oZ{ h, d }{ p, 1 }{ l, 2 }( :, :, 2 ) = zeros( size( oZ{ h, d }{ p, 1 }{ l, 2 }( :, :, 1 ) ), 'gpuArray' );
        ...
        % weighted sum + bias
        toZ = zeros( n_input( h, 2 ), n_input( h, 1 ), 'gpuArray' );
        ...
        for p = 1 : nP( h - 1 )
            ...
            for l = 1 : nL{ h - 1, d }( p, 1 )
                ...
                if l < nL{ h - 1, d }( p, 1 )
                    ...
                    oZ{ h - 1, d }{ p, 1 }{ l, 2 }( :, :, 2 ) = zeros( size( oZ{ h - 1, d }{ p, 1 }{ l, 2 }( :, :, 1 ) ), 'gpuArray' );
